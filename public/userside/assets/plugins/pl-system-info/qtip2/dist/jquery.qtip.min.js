...
(function(e, t, n) {
    (function(e) {
        ...
        function P(e) {
            ...
            if ("content" in e) {
                if (t(e.content) || e.content.jquery) e.content = {
                    text: e.content
                };
                n(e.content.text || s) && (e.content.text = s), "title" in e.content && (t(e.content.title) && (e.content.title = {
        ...
        function H(u, a, m, g) {
            ...
            function J() {
                var e = H + "-title";
                q.titlebar && X(), q.titlebar = r("<div />", {
                    "class": x + "-titlebar " + (a.style.widget ? "ui-widget-header" : "")
                }).append(q.title = r("<div />", {
                    id: e,
                    "class": x + "-title",
                    "aria-atomic": i
            ...
            function Q(e, t) {
                ...
                e.jquery && e.length > 0 ? n.empty().append(e.css({
                    display: "block"
                })) : n.html(e), y.redraw(), t !== s && y.rendered && F[0].offsetWidth > 0 && y.reposition(R.event)
            }
            ...
            function G(e, t) {
                ...
                var i = q.content;
                return !y.rendered || !e ? s : (r.isFunction(e) && (e = e.call(u, R.event, y) || ""), e.jquery && e.length > 0 ? i.empty().append(e.css({
                    display: "block"
                })) : i.html(e), y.rendered < 0 ? F.queue("fx", o) : (j = 0, o(r.noop)), y)
            }
            ...
            function Y() {
                ...
                F.bind("mouseenter" + I + " mouseleave" + I, function(e) {
                    ...
                    var t = r(e.target),
                        n = y.rendered && !F.hasClass(N) && F[0].offsetWidth > 0,
                        i = t.parents(C).filter(F[0]).length > 0;
            ...
            var y = this,
                ...
                I = ".qtip-" + m,
                q, R;
            y.id = m, y.rendered = s, y.destroyed = s, y.elements = q = {
                target: u
            }, y.timers = {
                img: {}
            }, y.options = a, y.checks = {}, y.plugins = {}, y.cache = R = {
                event: {},
                target: r(),
                disabled: s,
                attr: g,
                ...
                get: function(e) {
                    ...
                    switch (e.toLowerCase()) {
                        case "dimensions":
                            t = {
                                height: F.outerHeight(s),
                                width: F.outerWidth(s)
                            };
                            break;
                        case "offset":
                ...
                set: function(e, t) {
                    function p(e, t) {
                        ...
                        for (n in c)
                            for (r in c[n])
                                if (i = (new RegExp(r, "i")).exec(e)) t.push(i), c[n][r].apply(y, t)
                    }
                    var n = /^position\.(my|at|adjust|target|container)|style|content|show\.ready/i,
                        u = /^content\.(title|attr)|style/i,
                        f = s,
                        l = s,
                        c = y.checks,
                        h;
                ...
                toggle: function(e, n) {
                    ...
                    var o = e ? "show" : "hide",
                        ...
                        c = a.content,
                        h = F[0].offsetWidth > 0,
                        p = e || u.target.length === 1,
                        d = !n || u.target.length < 2 || R.target[0] === n.target,
                        v, g;
                ...
                focus: function(e) {
                    if (!y.rendered) return y;
                    var t = r(C),
                        n = parseInt(F[0].style.zIndex, 10),
                        i = b.zindex + t.length,
                        s = r.extend({}, e),
                        o;
        ...
        function B(e, n) {
            var u, a, f, l, c, h = r(this),
                p = r(t.body),
                d = this === t ? p : h,
                v = h.metadata ? h.metadata(n.metadata) : o,
                m = n.metadata.type === "html5" && v ? v[n.metadata.name] : o,
                g = h.data(n.metadata.name || "qtipopts");
            try {
            ...
            if (r.data(this, "qtip"))
                if (l.overwrite) h.qtip("destroy");
                else if (l.overwrite === s) return s;
        ...
        function j(e) {
            var t = this,
                n = e.elements.tooltip,
                o = e.options.content.ajax,
                u = b.defaults.content.ajax,
                a = ".qtip-ajax",
            ...
            e.checks.ajax = {
                ...
                load: function(n) {
                    ...
                    var a = o.url.lastIndexOf(" "),
                        p = o.url,
                        d, v = !o.loading && l;
                    if (v) try {
                        n.preventDefault()
                    } catch (m) {} else if (n && n.isDefaultPrevented()) return t;
        ...
        function I(e, t) {
            ...
            function _(t, r, o, f) {
                if (!b.tip) return;
                var l = m.corner.clone(),
                    w = o.adjusted,
                    E = e.options.position.adjust.method.split(" "),
                    x = E[0],
                    T = E[1] || E[0],
                    N = {
                        left: s,
            ...
            function H(e) {
                var t = b.titlebar && e.y === c,
                    n = t ? b.titlebar : b.content,
                    i = r.browser.mozilla,
                    s = i ? "-moz-" : r.browser.webkit ? "-webkit-" : "",
                    o = "border-radius-" + e.y + e.x,
                    u = "border-" + e.y + "-" + e.x + "-radius",
                    a = function(e) {
            ...
            function B(e) {
                ...
                var t, n, o, u = b.tip.css("cssText", ""),
                    ...
                    d = " !important",
                    y = b.titlebar,
                    w = y && (a.y === c || a.y === v && u.position().top + x.height / 2 + g.offset < y.outerHeight(i)),
                    S = w ? y : b.content;
                A(function() {
            ...
            function j(e) {
                var t = e.precedance === a,
                    n = x[t ? f : l],
                    r = x[t ? l : f],
                    i = e.string().indexOf(v) > -1,
                    s = n * (i ? .5 : 1),
                    o = Math.pow,
                    u = Math.round,
                    c, h, p, d = Math.sqrt(o(s, 2) + o(r, 2)),
                    m = [N / s * d, N / r * d];
            ...
            m.corner = o, m.mimic = o, m.border = N, m.offset = g.offset, m.size = x, e.checks.tip = {
                ...
                "^style.tip.(height|width)$": function() {
                    x = {
                        width: g.width,
                        height: g.height
                    }, m.create(), m.update(), e.reposition()
                },
                ...
                create: function() {
                    var e = x.width,
                        t = x.height,
                        n;
                    b.tip && b.tip.remove(), b.tip = r("<div />", {
            ...
            n.checks.modal = {
                ...
                init: function() {
                    return u.on ? (g = o.create(), f.attr(p, i).css("z-index", w.modal.zindex + r(C + "[" + p + "]").length).unbind(c).unbind(h).bind("tooltipshow" + c + " tooltiphide" + c, function(e, t, n) {
                        ...
                        if (e.target === f[0])
                            if (i && e.type === "tooltiphide" && /mouse(leave|enter)/.test(i.type) && r(i.relatedTarget).closest(g[0]).length) try {
                                e.preventDefault()
                            } catch (s) {} else(!i || i && !i.solo) && o[e.type.replace("tooltip", "")](e, n)
        ...
        D = r("<div/>", {
            ...
            if ("string" == typeof e) return this.each(function() {
                ...
                if (a !== "option" && a !== "options" || !t) e[a] && e[a].apply(e[a], l);
                else {
            ...
            fn: {
                ...
                clone: function(e) {
                    var t = r([]),
                        n = "title",
                        i = r.fn["clone" + O].apply(this, arguments);
            ...
            var t = e.style,
                n;
            t && "tip" in t && (n = e.style.tip, typeof n != "object" && (e.style.tip = {
                corner: n
            }), /string|boolean/i.test(typeof n.corner) || (n.corner = i), typeof n.width != "number" && delete n.width, typeof n.height != "number" && delete n.height, typeof n.border != "number" && n.border !== i && delete n.border, typeof n.offset != "number" && delete n.offset)
        }, r.extend(i, b.defaults, {
            style: {
                tip: {
                    corner: i,
            ...
            function j(e, t, n, i, s, o, u, a, f) {
                var l = r[s],
                    ...
                    x = d - l + E,
                    N = l + f - A[u] - d + E,
                    C = m - (S.precedance === e || c === S[t] ? b : 0) - (h === v ? a / 2 : 0);
            ...
            t.jquery || (t = r(t));
            var s = e.cache.areas = {},
                o = (t[0].shape || t.attr("shape")).toLowerCase(),
                u = t[0].coords || t.attr("coords"),
                a = u.split(","),
                f = [],
                l = r('img[usemap="#' + t.parent("map").attr("name") + '"]'),
                m = l.offset(),
                g = {
                    width: 0,
                    height: 0,
